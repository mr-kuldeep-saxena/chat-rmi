...
/**
 * This class contains a user settings used while his data is at another user's system
...
public class UserSettings implements Serializable {
	 ...
	 * Default Constructor
	 * @param id user's id
	 * @param value a displayable value (such as user's name)
	 * @param isGroup this object may also be used for displaying user in tree, this variable distinguish between 
	 * whether its a user object or group object  
	...
	/**
	 * @param value The value normally userName to set.
	 */
	...
	/**
	 * @param selected The selectecd to set.
	 */
	...
	/**
	 * @param userOfflineStatusMsg The userOfflineStatusMsg to set.
	 */
	...
	/**
	 * @param userOnlineStatusMsg The userOnlineStatusMsg to set.
	 */
