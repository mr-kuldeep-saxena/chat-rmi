...
public class TransparentScrollPane extends JScrollPane
{
	...
	/**
	 * consttructor
	 * @param P_data adds the component to the scroll pane
	 */
	...
	/**
	 * constructor
	 * @param P_data component to be added
	 * @param vertical vertical scroll bar policy
	 * @param horizontal horizontal scroll bar policy
	 */
	...
	/**
	 * overridden
	 * always returns false to make it transparent component
	 * @return false
	 */
