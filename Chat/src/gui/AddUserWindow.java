	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if (e.getSource() == B_add)
		{
			...
			if (RB_newGroup.isSelected())
			{
				...
				{
					if (((String)CMB_groups.getItemAt(i)).equalsIgnoreCase(groupName))
					{
						isNewGroup = false;
						break;
					}
			...
			int status = ClientSideCommunicator.getDefaultInstance().addUserToGroup (Utilities.getDefaultInstance().getCurrentUser(),TF_userName.getText().trim(), groupName, isNewGroup);
