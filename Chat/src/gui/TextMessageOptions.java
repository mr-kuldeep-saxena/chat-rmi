...
/**
 * This class displays a dialog from which user can user various text 
 * related options
...
public class TextMessageOptions extends JDialog implements ActionListener {
	 ...
	 */
	private JPanel P_north, P_center, P_south, P_preview, P_controls, P_note, P_buttons;
	...
	public TextMessageOptions(ChatWindow cw)
	{
		...
		mpcontrol.setFont(new Font(cw.getSelectedFontName(), Font.PLAIN, cw.getSelectedFontSize()));
	...
	private void initComponents ()
	{
		...
		TA_note = new JTextArea("Note: These options are not applicable in case of message sent after selecting the show in message box option");
		...
		P_controls.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Options"));
		P_preview.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), "Preview"));
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		mpcontrol.setFont(new Font(cw.getSelectedFontName(), fontType, cw.getSelectedFontSize()));
		...
		if (e.getSource() instanceof JComboBox)
		{
			...
			String selectedValue = (String) CMB_textFillingOptions.getSelectedItem();
