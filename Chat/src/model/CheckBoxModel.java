...
/**
 * provides a custom model for List control such that UserSettings object can
 * be stored in it.
...
public class CheckBoxModel extends AbstractListModel {
	 ...
	 * @param us UserSettings object to add to model
	 */
	public void addElement (UserSettings us)
	{
		// Creating new object such that both windows has separate properties 
		UserSettings us2 = new UserSettings (us.getUserID(),us.getValue(),us.isGroup(),us.getUserStatus());
	 ...
	 * @param index index in the array list to be updates
	 * @param value select/unselect flag
	 */
	 ...
	 * @param defaultUserID new default user id
	 */
