 ...
 *
 */
public class CheckBoxListCellRenderer extends JLabel implements ListCellRenderer
{
	/**
	 * @serial serial key
	 */
	...
	public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean hasFocus) 
	{
		...
		if (cbp.getUserID().equalsIgnoreCase(((CheckBoxModel)list.getModel()).getDefaultUserID()) || cbp.isSelected())
		{
