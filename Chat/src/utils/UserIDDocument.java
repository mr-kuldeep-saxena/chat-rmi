...
/**
 * provides a document for the text field which does not allows \/:*?"<>|$ in related textfield
 * used in userid textfield
 */
...

{
	 ...
	 */
	public void insertString(int int_offset,String str_text,AttributeSet AS_attributes)
	{
		...
		try
		{
			...
			{
				JOptionPane.showMessageDialog(null,"This Field can contain only Numeric values ", "Warrning ", JOptionPane.ERROR_MESSAGE);
			}
		}
		catch(Exception e)
		{
